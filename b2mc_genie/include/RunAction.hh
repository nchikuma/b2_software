#ifndef _RUN_ACTION_H
#define _RUN_ACTION_H
...
public:
  //RunAction(char* filename);
  RunAction(char*,TTree*);
  virtual ~RunAction();
  ...
  inline  EventSummary* GetEvtSum(){ return evt; }
  
  //inline  TTree* GetSKTree(){ return h1; }//for t2kreweight
  inline  TTree* GetGenieTree(){ return tree_genie; } 
