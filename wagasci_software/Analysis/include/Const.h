...
class Recon_t
{
  public:
    ...
    bool   recon_connected [MAX_NUM_TRACK];
    bool   recon_miss_paired [MAX_NUM_TRACK];
...
class Track_t
{
  public:
    ...
    int    track_likelihood[MAX_NUM_TRACK];
    bool   track_ing_match [MAX_NUM_TRACK];
    int    track_ingtrk_id [MAX_NUM_TRACK];
    double track_ing_diff  [MAX_NUM_TRACK];
    bool   track_pm_match  [MAX_NUM_TRACK];
    int    track_pmtrk_id  [MAX_NUM_TRACK];
    double track_pm_diff   [MAX_NUM_TRACK];
    int    track_ingcyc    [MAX_NUM_TRACK];
    int    track_ing_stopz [MAX_NUM_TRACK];
    double track_ing_stopxy[MAX_NUM_TRACK];
...
public:
  ...
  bool    ingrecon_wg_match[MAX_NUM_INGRECON];
  int     ingrecon_wgtrk_id[MAX_NUM_INGRECON];
  ...
  bool    pmrecon_wg_match[MAX_NUM_INGRECON];
  int     pmrecon_wgtrk_id[MAX_NUM_INGRECON];
...
class Info_t
{
  public:
    Long64_t start_time;
    Long64_t stop_time;
    Long64_t nb_data_pkts;
    Long64_t nb_lost_pkts;
};
...
public:
  ...
  char* BSDMERGE_DIRECTORY;   //2017/12/22
