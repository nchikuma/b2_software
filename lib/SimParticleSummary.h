#ifndef SIMPARTICLESUMMARY_H
#define SIMPARTICLESUMMARY_H
#include <iostream>
#include "TObject.h"

//......................................................................

class SimParticleSummary : public TObject
{
public:
    SimParticleSummary();
    virtual ~SimParticleSummary();
...
private:
    ...
    ClassDef(SimParticleSummary, 3) //  Simulation (detector mc) particle Summary
        };

#endif // SIMPARTICLESUMMARY_H
////////////////////////////////////////////////////////////////////////
