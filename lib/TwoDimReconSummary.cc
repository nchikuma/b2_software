...
TwoDimReconSummary::TwoDimReconSummary():
  nhits(0), ntracks(0)
{ 
  view        = -1;
  clstime     = -1.e5;
...
//......................................................................
TwoDimReconSummary::TwoDimReconSummary(const TwoDimReconSummary& basicsum) :
  nhits(0), ntracks(0)
{ 
  view        = basicsum. view;
...
void TwoDimReconSummary::Clear(Option_t* option)
{
  for (int i=0; i<HIT_MAXHITS; ++i)
    fHit[i] = TRef(NULL);
  nhits = 0;
...
void TwoDimReconSummary::Print()
{

}
//......................................................................
void TwoDimReconSummary::AddHit(HitSummary* hit) 
{
...
HitSummary* TwoDimReconSummary::GetHit(int i) const
{ 
...
void TwoDimReconSummary::AddTrack(TrackSummary* trk) 
{
...
TrackSummary* TwoDimReconSummary::GetTrack(int i) const
{ 
