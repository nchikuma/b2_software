...
BasicReconSummary::BasicReconSummary():
  nhits(0), ntracks(0)
{ 
  Ntrack      = -1;
  clstime     = -1.e5;
...
//......................................................................
BasicReconSummary::BasicReconSummary(const BasicReconSummary& basicsum) :
  nhits(0), ntracks(0)
{ 
...
void BasicReconSummary::Clear(Option_t* option)
{
  for (int i=0; i<HIT_MAXHITS; ++i)
    fHit[i] = TRef(NULL);
  nhits = 0;
...
void BasicReconSummary::Print()
{

}
//......................................................................
void BasicReconSummary::AddHit(HitSummary* hit) 
{
...
HitSummary* BasicReconSummary::GetHit(int i) const
{ 
...
void BasicReconSummary::AddTrack(TrackSummary* trk) 
{
...
TrackSummary* BasicReconSummary::GetTrack(int i) const
{ 
