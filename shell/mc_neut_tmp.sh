...
then
  ...
  echo -e "---------\n ${cmd}\n"; eval $cmd
  cmd=`printf "%s/B2Plot -i %s -o %s -m 7 -t %s %s" ${ANALYSIS_DIR} ${ANAFILE2} ${PLOTFILE2} ${TUNEFILE} ${OPT_RATIO}`
  echo -e "---------\n ${cmd}\n"; eval $cmd
  cmd=`printf "%s/B2Plot -i %s -o %s -m 8 -t %s %s" ${ANALYSIS_DIR} ${ANAFILE3} ${PLOTFILE3} ${TUNEFILE} ${OPT_RATIO}`
  echo -e "---------\n ${cmd}\n"; eval $cmd
  cmd=`printf "%s/B2Plot -i %s -o %s -m 8 -t %s %s" ${ANALYSIS_DIR} ${ANAFILE4} ${PLOTFILE4} ${TUNEFILE} ${OPT_RATIO}`
  echo -e "---------\n ${cmd}\n"; eval $cmd
  cmd=`printf "%s/B2Plot -i %s -o %s -m 9 -t %s %s" ${ANALYSIS_DIR} ${ANAFILE5} ${PLOTFILE5} ${TUNEFILE} ${OPT_RATIO}`
  echo -e "---------\n ${cmd}\n"; eval $cmd
  cmd=`printf "%s/B2Plot -i %s -o %s -m 9 -t %s %s" ${ANALYSIS_DIR} ${ANAFILE6} ${PLOTFILE6} ${TUNEFILE} ${OPT_RATIO}`
  echo -e "---------\n ${cmd}\n"; eval $cmd
  ...
  do
    ...
    do
      ...
      do
        ...
        cmd=`printf "%s/B2Plot -i %s -o %s -m 7 -t %s -w %d -r %s %s" ${ANALYSIS_DIR} ${ANAFILE1} ${PLOTFILE1} ${TUNEFILE} ${dial} ${REWEIGHTFILE1} ${OPT_RATIO}`
        echo -e "---------\n ${cmd}\n"; eval $cmd
        cmd=`printf "%s/B2Plot -i %s -o %s -m 7 -t %s -w %d -r %s %s" ${ANALYSIS_DIR} ${ANAFILE2} ${PLOTFILE2} ${TUNEFILE} ${dial} ${REWEIGHTFILE2} ${OPT_RATIO}`
        echo -e "---------\n ${cmd}\n"; eval $cmd
        cmd=`printf "%s/B2Plot -i %s -o %s -m 8 -t %s -w %d -r %s %s" ${ANALYSIS_DIR} ${ANAFILE3} ${PLOTFILE3} ${TUNEFILE} ${dial} ${REWEIGHTFILE3} ${OPT_RATIO}`
        echo -e "---------\n ${cmd}\n"; eval $cmd
        cmd=`printf "%s/B2Plot -i %s -o %s -m 8 -t %s -w %d -r %s %s" ${ANALYSIS_DIR} ${ANAFILE4} ${PLOTFILE4} ${TUNEFILE} ${dial} ${REWEIGHTFILE4} ${OPT_RATIO}`
        echo -e "---------\n ${cmd}\n"; eval $cmd
    
        if test $j -eq 1 -a $k -eq 3
        then
          for i in `seq 0 11`
          do
            inttype=$i
            ...
            cmd=`printf "%s/B2Plot -i %s -o %s -m 7 -t %s -c %d -w %d -r %s" ${ANALYSIS_DIR} ${ANAFILE1} ${PLOTFILE1_0} ${TUNEFILE} ${inttype} ${dial} ${REWEIGHTFILE1}`
            echo -e "---------\n ${cmd}\n"; eval $cmd
            cmd=`printf "%s/B2Plot -i %s -o %s -m 8 -t %s -c %d -w %d -r %s" ${ANALYSIS_DIR} ${ANAFILE3} ${PLOTFILE3_0} ${TUNEFILE} ${inttype} ${dial} ${REWEIGHTFILE3}`
            echo -e "---------\n ${cmd}\n"; eval $cmd
          done
        fi
      done
...
#      cmd=`printf "%s/ThreeDimRecon -f %s -o %s -m1 -v -x -n %d %s" ${ANALYSIS_DIR} ${RECONFILE5} ${DET_ANAFILE5} ${dial} ${OPT_NOT3DRRK}`
#      echo -e "---------\n ${cmd}\n"; eval $cmd
#      cmd=`printf "%s/B2Plot -i %s -o %s -m 9 -t %s" ${ANALYSIS_DIR} ${DET_ANAFILE5} ${DET_PLOTFILE5} ${TUNEFILE}`
#      echo -e "---------\n ${cmd}\n"; eval $cmd
#      cmd=`printf "rm -f %s" ${DET_ANAFILE5}`
#      echo -e "---------\n ${cmd}\n"; eval $cmd
#
#      cmd=`printf "%s/ThreeDimRecon -f %s -o %s -m1 -v -x -n %d %s" ${ANALYSIS_DIR} ${RECONFILE6} ${DET_ANAFILE6} ${dial} ${OPT_NOT3DRRK}`
#      echo -e "---------\n ${cmd}\n"; eval $cmd
#      cmd=`printf "%s/B2Plot -i %s -o %s -m 9 -t %s" ${ANALYSIS_DIR} ${DET_ANAFILE6} ${DET_PLOTFILE6} ${TUNEFILE}`
#      echo -e "---------\n ${cmd}\n"; eval $cmd
#      cmd=`printf "rm -f %s" ${DET_ANAFILE6}`
#      echo -e "---------\n ${cmd}\n"; eval $cmd

    else
      ##Plot 
      cmd=`printf "%s/B2Plot -i %s -o %s -m 7 -t %s -n %d" ${ANALYSIS_DIR} ${ANAFILE1} ${DET_PLOTFILE1} ${TUNEFILE} ${dial}`
      echo -e "---------\n ${cmd}\n"; eval $cmd
      cmd=`printf "%s/B2Plot -i %s -o %s -m 7 -t %s -n %d" ${ANALYSIS_DIR} ${ANAFILE2} ${DET_PLOTFILE2} ${TUNEFILE} ${dial}`
      echo -e "---------\n ${cmd}\n"; eval $cmd
      cmd=`printf "%s/B2Plot -i %s -o %s -m 8 -t %s -n %d" ${ANALYSIS_DIR} ${ANAFILE3} ${DET_PLOTFILE3} ${TUNEFILE} ${dial}`
      echo -e "---------\n ${cmd}\n"; eval $cmd
      cmd=`printf "%s/B2Plot -i %s -o %s -m 8 -t %s -n %d" ${ANALYSIS_DIR} ${ANAFILE4} ${DET_PLOTFILE4} ${TUNEFILE} ${dial}`
      echo -e "---------\n ${cmd}\n"; eval $cmd
#      cmd=`printf "%s/B2Plot -i %s -o %s -m 9 -t %s -n %d" ${ANALYSIS_DIR} ${ANAFILE5} ${DET_PLOTFILE5} ${TUNEFILE} ${dial}`
#      echo -e "---------\n ${cmd}\n"; eval $cmd
#      cmd=`printf "%s/B2Plot -i %s -o %s -m 9 -t %s -n %d" ${ANALYSIS_DIR} ${ANAFILE6} ${DET_PLOTFILE6} ${TUNEFILE} ${dial}`
#      echo -e "---------\n ${cmd}\n"; eval $cmd
    fi
