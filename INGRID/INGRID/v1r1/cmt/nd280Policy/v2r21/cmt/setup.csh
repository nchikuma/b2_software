...
${CMTROOT}/mgr/cmt setup -csh -pack=nd280Policy -version=v2r21 -path=/gpfs/fs03/t2k/beam/work/nchikuma/B2/b2_software/INGRID/INGRID/v1r1/cmt  -no_cleanup $* >${tempfile}; source ${tempfile}
/bin/rm -f ${tempfile}
